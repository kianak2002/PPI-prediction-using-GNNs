...
def test(model, graph, test_mask, device):
    ...
    print("Accuracy: {}, Recall: {}, Precision: {}, F1: {}, AUROC: {}, LPA: {}".format(metrics.Accuracy, metrics.Recall, metrics.Precision, metrics.F1, metrics.AUROC, metrics.LPA))
...
def main():
    ...
    # model = GAT_Net(in_len=2000, in_feature=13, hidden_dim=8, num_layers=1, num_heads=4, dropout=0.5, feature_fusion=None, class_num=7).to(device)
