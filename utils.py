...
class Metrictor_PPI:
    ...
    def show_result(self, is_print=False, file=None):
        ...
        self.AUROC = (self.Recall + (self.FP/(self.FP + self.TN + 1e-10))) / 2
        self.LPA = (self.TP + self.TN) / (self.TP + self.TN + self.FP + self.FN)
        if is_print:
            ...
            print_file("AUROC: {}".format(self.AUROC), file)
            print_file("LPA: {}".format(self.LPA), file)
